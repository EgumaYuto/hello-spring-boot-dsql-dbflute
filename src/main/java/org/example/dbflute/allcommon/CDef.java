package org.example.dbflute.allcommon;
...
public interface CDef extends Classification {
     ...
     * TODO status
     */
    public enum TodoStatus implements CDef {
        /** To Do */
        ToDo("TODO", "To Do"),
        /** Doing */
        Doing("DOING", "Doing"),
        /** Done */
        Done("DONE", "Done");
        private static ZzzoneSlimmer<TodoStatus> _slimmer = new ZzzoneSlimmer<>(TodoStatus.class, values());
        private String _code; private String _alias;
        private TodoStatus(String code, String alias) { _code = code; _alias = alias; }
        public String code() { return _code; } public String alias() { return _alias; }
        public Set<String> sisterSet() { return Collections.emptySet(); }
        public Map<String, Object> subItemMap() { return Collections.emptyMap(); }
        public ClassificationMeta meta() { return CDef.DefMeta.TodoStatus; }
         ...
         */
        public static OptionalThing<TodoStatus> of(Object code) { return _slimmer.of(code); }
        /**
         * Find the classification by the name. (CaseInsensitive)
         * @param name The string of name, which is case-insensitive. (NotNull)
         * @return The optional classification corresponding to the name. (NotNull, EmptyAllowed: if not found, returns empty)
         */
        public static OptionalThing<TodoStatus> byName(String name) { return _slimmer.byName(name); }
        /**
         * <span style="color: #AD4747; font-size: 120%">Old style so use of(code).</span>
         * @param code The value of code, which is case-insensitive. (NullAllowed: if null, returns null)
         * @return The instance of the corresponding classification to the code. (NullAllowed: if not found, returns null)
         */
        public static TodoStatus codeOf(Object code) { return _slimmer.codeOf(code); }
        /**
         ...
         */
        @Deprecated
        public static TodoStatus nameOf(String name) { return _slimmer.nameOf(name, nm -> valueOf(nm)); }
        /**
         * Get the list of all classification elements. (returns new copied list)
         * @return The snapshot list of all classification elements. (NotNull)
         */
        public static List<TodoStatus> listAll() { return _slimmer.listAll(values()); }
        /**
         ...
         */
        public static List<TodoStatus> listByGroup(String groupName) {
            if (groupName == null) { throw new IllegalArgumentException("The argument 'groupName' should not be null."); }
            throw new ClassificationNotFoundException("Unknown classification group: TodoStatus." + groupName);
        }
        /**
         ...
         */
        @Deprecated
        public static List<TodoStatus> listOf(Collection<String> codeList) { return _slimmer.listOf(codeList); }
        /**
         ...
         */
        @Deprecated
        public static List<TodoStatus> groupOf(String groupName) { return new ArrayList<>(); }
        @Override public String toString() { return code(); }
    }

    public enum DefMeta implements ClassificationMeta {
        /** TODO status */
        TodoStatus(cd -> CDef.TodoStatus.of(cd), nm -> CDef.TodoStatus.byName(nm)
        , () -> CDef.TodoStatus.listAll(), gp -> CDef.TodoStatus.listByGroup(gp)
