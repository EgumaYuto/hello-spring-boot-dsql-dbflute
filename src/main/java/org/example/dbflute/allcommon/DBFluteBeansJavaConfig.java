 ...
 */
@Configuration
@ComponentScan(value="org.example.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    protected DBFluteInitializer newDBFluteInitializer(DataSource dataSource) {
        return new org.example.dbflute.allcommon.DBFluteInitializer(dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.example.dbflute.allcommon.ImplementedInvokerAssistant();
    }
